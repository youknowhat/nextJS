...
var Index = function Index(props) {
  return __jsx(_components_Layout__WEBPACK_IMPORTED_MODULE_2__["default"], null, __jsx("h1", null, "Shows"), __jsx("ul", null, getPosts().map(function (post) {
    return __jsx("li", {
      key: post.id
    }, __jsx(next_link__WEBPACK_IMPORTED_MODULE_3___default.a, {
      as: "/post/".concat(post.id),
      href: "/post?id=".concat(post.title)
    }, __jsx("a", null, show.title)));
  })));
};
...
//# sourceMappingURL=index.js.01b6eec88b5b68c5de9e.hot-update.js.map